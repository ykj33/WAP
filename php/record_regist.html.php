...
//    print "등록이 완료되었습니다." . $upload_file_path;
        ...
        $sql = "INSERT INTO rikarsong.record (identifier, record_id, title, creator, collector, date_from, date_to, extent, medium, scope, type, description, level_of_description, url, delete_Yn, kind_of)
            VALUES (:identifier, :record_id, :title, :creator, :collector, :date_from, :date_to, :extent, :medium, :scope, :type, :description, 'item', :url, 'N', :kind_of)";
        $stmh = $pdo->prepare($sql);
