...
// identifier는 record_id에 WP_를 붙여 사용
    ...
    // windows 환경
    $upload_file_dir = '/www/wap/upload/';
...
//print "등록이 완료되었습니다." . $upload_file_path;
    ...
    $sql = "INSERT INTO rikarsong.record (identifier, record_id, title, creator, collector, date_from, date_to, extent, medium, scope, type, description, url)
